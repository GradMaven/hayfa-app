...
- **Provider interfaces for AI/OCR/Storage/Integrations, mocked by default** — real vendors are a swap behind an existing interface, not a rewrite, and nothing touches a real AI vendor without an explicit, reviewed decision to enable it.
